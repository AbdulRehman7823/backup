...
function AddComponent() {
  ...
  const addPoetry= (e)=>{
    ...
    console.log(data);
    poetServices.addPoetry(data).then((res) => {
    ...
    <div className="p-14 justify-center">
      ...
      <div className="flex flex-row justify-around shadow-xl rounded-xl mt-14 p-10">
        ...
        <div className="flex items-center justify-center w-1/2 px-14">
          ...
          </label>:<img className=" w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                            src={iurl} alt="no image"/>}
        </div>
      </div>
    </div>
  );
